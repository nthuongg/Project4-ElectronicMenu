...
const OrderStatus = ({ status }) => {
    ...
    const [rowsPerPage] = useState(7); // Số lượng đơn hàng hiển thị trên mỗi trang
    ...
    return (
        <Box>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', mt: 2 }}>
                <Pagination
                    count={Math.ceil(orderItems.length / rowsPerPage)} // Tính toán số trang
                    page={page}
                    onChange={(event, value) => setPage(value)} // Cập nhật trang khi người dùng chọn
                    variant="outlined"
                    shape="rounded"
                    sx={{
                        ...
                        '& .MuiPaginationItem-ellipsis': {
                            color: 'white', // Đổi màu chữ cho dấu ba chấm
                        },
                        '& .MuiPaginationItem-outlined': {
                            borderColor: 'white', // Đổi màu viền
                        },
                        '& .MuiPaginationItem-outlined.Mui-selected': {
                            backgroundColor: 'rgba(255, 255, 255, 0.12)', // Màu nền cho trang đang chọn
                            color: 'white',
                        },
                    }}
                />
